                    ...
                    <div class="x_content">
                        <form id="frmRegistro" class="form-horizontal form-label-left">
                            <div id="imprimir_form">
                                <h3>Atención en Consultorio</h3>
                                <br>
                                <div class="form-group">
                                    <label for="dni" class="form-label col-md-3">Código de Atención:</label>
                                    <div class="col-md-9">
                                        <input type="number" class="form-control col-md-6" id="codigo" placeholder="codigo" required readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control col-md-6" id="dni" placeholder="DNI" required readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" name="motivo_c" id="motivo_c" cols="30" rows="5" required readonly></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="diagnostico_c" class="form-label col-md-3">Diagnóstico:</label>
                                    <div class="col-md-9">
                                        <textarea class="form-control" name="diagnostico_c" id="diagnostico_c" cols="30" rows="5" required readonly></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
...
<script>
    const id = "<?php $pagina = explode("/", $_GET['views']);
                echo $pagina['1'] ?>";
    mostrar_consulta(id);
</script>