...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Módulos Formativos</h4>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title h4" id="myLargeModalLabel">Registrar Módulo Formativo</h5>
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group row mb-2">
                                        <label for="nro_modulo" class="col-3 col-form-label">Nro. Módulo Formativo</label>
                                        <div class="col-9">
                                            <input type="number" class="form-control" id="nro_modulo">
                                        </div>
                                    </div>
                ...
                <table id="example" class="table dt-responsive " width="100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>DPW</td>
                            <td>1</td>
                            <td>ANALISIS Y DISEÑO DE SISTEMAS WEB</td>
                            <td>
                    ...
                    <div class="modal fade bd-example-modal-edit" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title h4" id="myLargeModalLabel">Editar Módulo Formativo</h5>
                                    <button type="button" class="close waves-effect waves-light" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
