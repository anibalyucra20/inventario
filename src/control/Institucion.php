        ...
        if ($_POST) {
            ...
            if ($cod_modular == "" || $ruc == "" || $nombre == "") {
                ...
                if ($arr_Institucion) {
                    ...
                    $id_institucion = $objInstitucion->registrarInstitucion($cod_modular, $ruc, $nombre);
                    if ($id_institucion > 0) {
            ...
            if ($id == "" || $cod_modular == "" || $ruc == "" || $nombre == "") {
                ...
                if ($arr_Institucion) {
                    if ($arr_Institucion->id == $id) {
                        $consulta = $objInstitucion->actualizarInstitucion($id, $cod_modular, $ruc, $nombre);
                        if ($consulta) {
